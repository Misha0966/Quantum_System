...
Скопировать код в VS Code в файл любого названия, с обязательным расширением .jl, предварительно скачав приложение для Julia в нём же, после чего нажать на треугольник в верхней правой части, тем самым запустив код.
