...
Julia версии 1.6 или выше, скачать Julia можно с официального сайта: https://julialang.org 

обязательно указав при установке add Julia to PATH.

а так же следующие пакеты, после установки:
...
Скачать Julia можно с официального сайта: https://julialang.org 

Скачать VS Code с официального сайта: https://code.visualstudio.com 

Скачать Julia в расширениях VS Code.

Настроить среду выполния под Julia.

Добавить все пакеты, после установки самой Julia:

Julia

using Pkg

Pkg.add(["Flux", "Plots", "Random", "Distributions", "Dates"])

Скопировать код этого репозитория в VS Code в файл любого названия, с обязательным расширением .jl, предварительно скачав приложение для Julia в нём же, после чего нажать на треугольник в верхней правой части, тем самым запустив код.

Ещё один вариант проверки эксперимента, это использование Google Colab:

Перейти в Google Colab, нажать на New Notebook, дальше выбрать Среда выполнения, Сменить среду выполнения, и выбрать вместо Python, Julia, в поле Тип среды выполнения

Далее- сохранить, после чего нажать на Подключить. 

using Pkg

Pkg.add(["Flux", "Plots", "Random", "Distributions", "Dates"])

здесь сам код модели...
